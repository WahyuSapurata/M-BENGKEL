...
@push('scripts')
    <script>
        ...
        $('#formKategori').on('submit', function(e) {
            ...
            let updateUrl = `{{ route('admin.kategori-update', ':uuid') }}`;
        ...
        $('#dataTables').on('click', '.edit', function() {
            ...
            let editUrl = `{{ route('admin.kategori-edit', ':uuid') }}`;
        ...
        $('#dataTables').on('click', '.delete', function() {
            let uuid = $(this).data('uuid');
            let deleteUrl = `{{ route('admin.kategori-delete', ':uuid') }}`;
