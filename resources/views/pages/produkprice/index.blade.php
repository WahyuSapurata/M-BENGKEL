            ...
            <div class="page-header-right ms-auto">
                <div class="page-header-right-items ">
                    ...
                    <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                        <button class="btn btn-info" onclick="window.history.back()"><span>Kembali</span></button>
                                ...
                                <table style="width: 100%" id="dataTables" class="table table-hover mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-capitalize">hrg jual</th>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text" name="harga_jual" id="harga_jual" class="form-control formatRupiah">
                            <div class="invalid-feedback"></div>
                        </div>
                    </div>
...
@push('scripts')
    <script>
        ...
        $('#form').on('submit', function(e) {
            ...
            let updateUrl = `{{ route('admin.produk-price-update', ':uuid') }}`;
            updateUrl = updateUrl.replace(':uuid', uuid);

            let url = uuid ? updateUrl :
                `{{ route('admin.produk-price-store') }}`;
        ...
        $('#dataTables').on('click', '.edit', function() {
            ...
            let editUrl = `{{ route('admin.produk-price-edit', ':uuid') }}`;
        ...
        $('#dataTables').on('click', '.delete', function() {
            let uuid = $(this).data('uuid');
            let deleteUrl = `{{ route('admin.produk-price-delete', ':uuid') }}`;
        ...
        const initDatatable = () => {
            ...
            let postUrl = `{{ route('admin.produk-price-get', ':uuid') }}`;
            postUrl = postUrl.replace(':uuid', lastPart);
