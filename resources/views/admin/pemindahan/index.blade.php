            ...
            <form id="form">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-2">
                            <label class="text-capitalize form-label">nominal</label>
                            <input type="text" name="nominal" id="nominal" class="form-control formatRupiah">
                            <div class="invalid-feedback"></div>
                        </div>
                    </div>
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            // Format nominal sebagai mata uang Rupiah
